...
const ForwardService = class {
   ...
   */
  async find(params) { // eslint-disable-line require-await
   ...
   */
  async create(data, params) { // eslint-disable-line require-await
   ...
   */
  async update(id, data, params) { // eslint-disable-line require-await
   ...
   */
  async patch(id, data, params) { // eslint-disable-line require-await
   ...
   */
  async remove(id, params) { // eslint-disable-line require-await
